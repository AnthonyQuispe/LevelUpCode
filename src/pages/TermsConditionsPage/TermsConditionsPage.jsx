  ...
  return (
    <div className="termsconditions-page">
      ...
      <main className="termsconditions-page__main">
        ...
        <ol className="termsconditions-page__list">
          <li className="termsconditions-page__item">
            <h2 className="termsconditions-page__subtitle">
              Acceptance of Terms
            </h2>
            <p className="termsconditions-page__text">
              By accessing or using the LevelUp Code web application, you agree
          ...
          <li className="termsconditions-page__item">
            ...
            <p className="termsconditions-page__text">
              LevelUp Code provides a platform for users to learn how to code.
              All content and features provided by LevelUp Code are free of
              charge.
            </p>
          </li>
          <li className="termsconditions-page__item">
            ...
            <p className="termsconditions-page__text">
              ...
              <ul className="termsconditions-page__list--alt">
          ...
          <li className="termsconditions-page__item">
            <h2 className="termsconditions-page__subtitle">Data Usage:</h2>
            <p className="termsconditions-page__text">
              LevelUp Code may use the collected user information to:
              Personalize user experience Improve our services and content
              Analyze user behavior and preferences Send relevant notifications
              and updates Ensure the security of our platform
              <ul className="termsconditions-page__list--alt">
                <li className="termsconditions-page__list-item">
          ...
          <li className="termsconditions-page__item">
            <h2 className="termsconditions-page__subtitle">Privacy</h2>
            <p className="termsconditions-page__text">
              Protecting user privacy is a top priority for LevelUp Code. We
              will not sell, rent, or disclose user information to third parties
              without explicit consent, except as required by law.
            </p>
          </li>
          <li className="termsconditions-page__item">
            <h2 className="termsconditions-page__subtitle">Security</h2>
            <p className="termsconditions-page__text">
          ...
          <li className="termsconditions-page__item">
            <h2 className="termsconditions-page__subtitle">Content Usage:</h2>
            <p className="termsconditions-page__text">
          ...
          <li className="termsconditions-page__item">
            ...
            <p className="termsconditions-page__text">
              LevelUp Code reserves the right to modify or revise these terms
              and conditions at any time. Users will be notified of any changes,
              and continued use of the application after such modifications
              constitutes acceptance of the revised terms.
            </p>
          </li>
          <li className="termsconditions-page__item">
            <h2 className="termsconditions-page__subtitle">Governing Law</h2>
            <p className="termsconditions-page__text">
            ...
            <p className="termsconditions-page__text">
              ...
              conditions. Enjoy learning to code and leveling up your skills
              with us!
            </p>
          </li>
        </ol>
