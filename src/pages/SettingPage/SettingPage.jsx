      ...
      <>
        <main className="setting-page">
          <section className="setting-page__top-container">
            <Link className="setting-page__link-back">
              <img
                src={LeftArrowIcon}
                alt="left arrow icon"
                className="setting-page__link-img"
              />
            </Link>
            <h1 className="setting-page__title">Settings</h1>
          </section>
          <section className="setting-page__container">
            <h2 className="setting-page__subtitle">Account</h2>
            <div className="setting-page__button-container">
              <Link to="/setting/preferences" className="setting-page__button">
                Preferences <img src={RightArrowIcon} alt="right arrow icon" />
              </Link>
